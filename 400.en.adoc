...
* Complete the adoption of https://www.checklistbank.org/[ChecklistBank^] as part of the core GBIF services for indexing checklist datasets, with updated public GBIF APIs and documentation. Engage with interested parties to explore how to best make use of ChecklistBank for their own needs.
