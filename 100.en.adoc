...
* Engage high-priority thematic communities based on recommendations from the Science Committee and establish new consultations with with subject experts, data holders, data users and other communities on key topics, including agrobiodiversity, biodiversity loss and marine biodiversity (in collaboration with https://obis.net[Ocean Biodiversity Information System^] (OBIS))
